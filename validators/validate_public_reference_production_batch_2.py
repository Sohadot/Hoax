...
def validate_governance() -> bool:
    ...
    if pub.get("current_publisher_status") not in (
        ...
        error("publisher status must be batch 2, batch 3, standard v1, protocol v1 draft, interface thesis, static embodiment v1, or visual system hardening validation")
        ok = False
    gate = next(
