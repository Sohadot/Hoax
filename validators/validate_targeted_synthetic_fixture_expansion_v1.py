...
def validate_governance() -> bool:
    ...
    if policy.get("current_publisher_status") != PUBLISHER_STATUS_POST_TARGETED_SYNTHETIC_FIXTURE_EXPANSION_V1_VALIDATION:
        error("publisher status must be blocked_until_targeted_synthetic_fixture_expansion_v1_validation")
        ok = False
