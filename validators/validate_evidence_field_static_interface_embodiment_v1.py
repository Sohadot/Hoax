...
def validate_governance() -> bool:
    ...
    if policy.get("current_publisher_status") != PUBLISHER_STATUS_POST_EVIDENCE_FIELD_STATIC_INTERFACE_EMBODIMENT_V1:
        error("publisher status must be blocked_until_evidence_field_static_interface_embodiment_v1_validation")
        ok = False
